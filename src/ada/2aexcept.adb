...
--  This body is part of the VxWorks AE653 Level A runtime. It implements
...
package body Ada.Exceptions is
   ...
   procedure Process_Exception (E : Exception_Id);
   ...
   procedure Process_Exception (E : Exception_Id) is
   ...
   begin
      ...
      --  it. Otherwise, this is an unhandled exception.
