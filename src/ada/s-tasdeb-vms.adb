...
--     new ASCIC'(17, "Terminated [exc] ");
   ...
   is
      ...
      TI : constant String := "   Task %TASK !UI is "; --  Announce prefix
   begin
      if EVCB.Sub_Event /= 0 then
         Event_Kind := Event_Kind_Type (EVCB.Sub_Event);
      else
         Event_Kind := Event_Kind_Type (EVCB.Code);
      end if;
