...
private
   ...
   type Lock is new System.OS_Interface.thread_mutex_t;
   type RTS_Lock is new System.OS_Interface.thread_mutex_t;
   ...
   type Suspension_Object is record
      ...
      L : aliased System.OS_Interface.thread_mutex_t;
      --  Protection for ensuring mutual exclusion on the Suspension_Object

      CV : aliased System.OS_Interface.thread_cond_t;
   ...
   type Private_Data is record
      ...
      PThread : aliased System.OS_Interface.pthread_t;
      --  POSIX thread identifier needed for POSIX signal handling

      CV : aliased System.OS_Interface.thread_cond_t;
      --  Used for conditional and timed waits
