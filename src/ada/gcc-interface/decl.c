...
/* Stack realignment for functions with foreign conventions is provided on a
   ...
   as part of the function's body any more.  It might be requested by way of
   a dedicated function type attribute on the targets that support it.
