...
--  with the VxWorks Ravenscar / cert profile.
...
package body System.Tasking.Restricted.Stages is
   ...
   procedure Task_Wrapper (Self_ID : Task_Id) is
      ...
      Sec_Stack_Size : constant Storage_Elements.Storage_Offset :=
        Self_ID.Common.Compiler_Data.Pri_Stack_Info.Size / 4;
      --  Secondary stack is ~1/4 size of requested stack
   ...
   begin
      ...
      --  Normal termination.  An unhandled exception will have been passed on
      --  to the last chance handler. We're following the same protocol as with
      --  APEX processes.
